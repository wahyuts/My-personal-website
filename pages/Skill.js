        ...
        <div>
            ...
            <div className={styles.contLeft}>
                <div className={styles.contEachLeft}>
                    <div className={styles.marginImg}>
                        <Image src="/htmlLogo.png" alt="" width={300} height={300} />
                    </div>
            ...
            <div className={styles.contRight}>
                <div className={styles.contEachRight}>
                    <div className={styles.marginImg}>
                        <Image src="/cssLogo.png" alt="" width={300} height={300} />
                    </div>
            ...
            <div className={styles.contLeft}>
                <div className={styles.contEachLeft}>
                    <div className={styles.marginImgJS}>
                        <Image src="/JSLogo.png" alt=""  width={300} height={300}  />
                    </div>
            ...
            <div className={styles.contRight}>
                <div className={styles.contEachRight}>
                    <div className={styles.marginImgReact}>
                        <Image src="/ReactLogo.png" alt="" width={180} height={140} />
                    </div>
            ...
            <div className={styles.contLeftNext}>
                <div className={styles.contEachLeft}>
                    <div className={styles.marginImgJS}>
                        <Image src="/next-js.svg" alt="" width={150} height={150} />
                    </div>
